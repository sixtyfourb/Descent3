...
//
//	Left hand moves, right hand aims, as every twin-stick game has done since:
//	left stick slides and thrusts, right stick turns and pitches, bank comes off
//	the stick entirely. Buttons are numbered SDL index + 1, so A is 1 and Start
//	is 8, and only the joystick slot changes - the mouse and keyboard columns
//	beside it are untouched.
ct_function Controller_needs[NUM_CONTROLLER_FUNCTIONS] = {
    {ctfFORWARD_THRUSTAXIS, ctAnalog, ctAxis, ctAxis, CT_Y_AXIS, 0, 0, 0},
